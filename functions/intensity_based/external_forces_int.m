function [force, P_in, P_out] = external_forces_int(snake,B,I,X,Y)
%EXTERNAL_FORCES_INT Computes the external forces to evolve the curve
% Input:
%   snake: Closed snake
%   B: Biadjency matrix
%   I: Image
...
%   force: External forces
   ...
   P_in = reshape(B*p_in,size(I));
   P_out = reshape(B*p_out,size(I));
