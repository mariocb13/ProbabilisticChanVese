...
%
figure(1)
slange1 = DerformSegmentationNerv(Image,C,alpha,beta,10,N);
%hold off
slange1_3d(:,:,1) = slange1;
%%
for i = 2:20
    slange1_3d(:,:,i) = DerformSegmentationNerv(Nerves(:,:,i),slange1_3d(:,:,i-1),alpha,beta,10,10);
end
%%
x0 = 225; y0 = 95;
r = 12+16;
...
%
figure(2)
slange2 = DerformSegmentationNerv(Image,C,alpha,beta,10,N);
slange2_3d(:,:,1) = slange2;
for i = 2:50
    slange2_3d(:,:,i) = DerformSegmentationNerv(Nerves(:,:,i),slange2_3d(:,:,i-1),alpha,beta,10,10);
end
%%
x0 = 115; y0 = 175;
r = 12+14;
...
%
figure(3)
slange3 = DerformSegmentationNerv(Image,C,alpha,beta,10,N);
slange3_3d(:,:,1) = slange3;
for i = 2:20
    slange3_3d(:,:,i) = DerformSegmentationNerv(Nerves(:,:,i),slange3_3d(:,:,i-1),alpha,beta,10,10);
end
%% 2d plot
figure(4)
imshow(start);
